...
<body>
    <div class="container">
        ...
        <h3 style="text-align: center">Your Assignment Has Come To An End!</h3>
        <p>
            Please contact the admin for more information.
        </p>
        <p><q>Note</q> <i>This mail may serve as an update, if you have initially been posted, thank You.</i></p>
