                                            ...
                                            <table class="table table-striped dt-responsive nowrap w-100">
                                                ...
                                                @if($user->tasks->where('status', 'active')->isNotEmpty())
                                                    ...
                                                    @foreach($user->tasks->where('status', 'active') as $task)
                                                        ...
                                                        <tr>
                                                            <th class="text-info">Assignment Location</th>
                                                            <td>{{ $task->location }}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                               <p> {{ $task->getYearStartMonth() }} </p>
                                                               <p>{{ $task->duration_in_words }}</p>
                                                            </td>
                                                        </tr>
                                             ...
                                             @if(!$user->tasks->isEmpty() && $user->tasks->first()->status == "disabled")
                                             <table class="table table-hover">
                                                 <tr>
                                                     <th>Destination</th>
                                                     <th>Dates</th>
                                                 </tr>
                                                 @foreach($user->tasks as $duty)
                                                     <tr>
                                                         <td>{{ Str::title($duty->location) }}</td>
                                                         <td>
                                                             <p>{{ $duty->getYearStartMonth() }}</p>
                                                             <p>{{ $duty->duration_in_words }}</p>
                                                         </td>
                                                     </tr>
                                                 @endforeach
                                             </table>
                                         @elseif(!$user->tasks->isEmpty())
                                             <p class="alert alert-primary">Apostolic Work History Not Available</p>
                                         @else
                                             <p class="alert alert-primary">No Apostolic Work History Found</p>
                                         @endif
                                        </div>
